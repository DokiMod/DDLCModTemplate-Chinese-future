...
因为有你，因为有你，因为有你"""
    ...
    poem_n23_chs_plus = Poem(
        author = "natsuki",
        title = "",
        text = """\
我不知道从何讲起，但是我确实在担心。优里最近的行为很奇怪。你才来几天所以你也许不太懂我的意思。\
...
我其实一直想和优里成为朋友来着，看她这个样子我真的很难受。我知道换做平时的我是绝对不会承认的，\
但是现在我不在乎了。我只是觉得很无助。所以求求你看看能做点什么事情帮帮她。我可不想看她身上\
发生什么坏事。你愿意的话，我可以给你做纸杯蛋糕吃！真的，求你帮忙做点什么。

至于莫妮卡...我不知道为什么，但是她好像很不以为人。看起来她想让我们完全忽略优里的事。我现在\
对她很生气，所以我才来找你的。\
千万别让她知道我写了这些！！！！！就假装我给了你一首特别棒的诗，好吧？\
全靠你了，感谢读完！"""
        )

    poem_s1_chs_plus = Poem(
        author = "sayori",
        title = "亲爱的阳光",
        text = """\
清晨，你透过窗帘照在我身上
